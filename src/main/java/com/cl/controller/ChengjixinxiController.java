...
public class ChengjixinxiController {
     ...
     * 分段统计
     */
    @RequestMapping("/sectionStat/kaoshichengji/shijuanmingcheng")
    @IgnoreAuth
    public R shijuanmingchengkaoshichengjiSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<ChengjixinxiEntity> ew = new EntityWrapper<ChengjixinxiEntity>();
        List<Map<String, Object>> result = chengjixinxiService.shijuanmingchengkaoshichengjiSectionStat(params, ew);
        return R.ok().put("data", result);
    }
